...
The installer downloads a versioned release, verifies its SHA-256 checksum, installs the `andy-agent` command, and can prepare the Python runtime used by the agent.
