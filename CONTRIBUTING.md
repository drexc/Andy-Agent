...
Thanks for your interest in contributing to Prime Agent! Prime Agent is developed in public, and we welcome bug reports, feature requests, questions, and other feedback. To keep the project maintainable, public contributions begin in [GitHub Discussions](https://github.com/drexc/prime-agent/discussions).
...
- [General discussion or question](https://github.com/drexc/prime-agent/discussions/categories/general)
- [Bug report](https://github.com/drexc/prime-agent/discussions/categories/bug-reports)
- [Feature request](https://github.com/drexc/prime-agent/discussions/categories/feature-requests)
