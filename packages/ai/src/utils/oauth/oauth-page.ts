...
<body>
  <main>
    <div class="logo" aria-label="Andy">${ANDY_BUTTERFLY_SVG}</div>
    <h1>${heading}</h1>
    <p>${message}</p>
...
export function oauthSuccessHtml(message: string): string {
	return renderPage({
		title: "Andy authentication successful",
...
export function oauthErrorHtml(message: string, details?: string): string {
	return renderPage({
		title: "Andy authentication failed",
