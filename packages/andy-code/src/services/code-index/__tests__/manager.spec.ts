...
describe("CodeIndexManager - handleSettingsChange regression", () => {
	...
	describe("handleSettingsChange", () => {
		it("should log background indexing failures", async () => {
			...
			expect(consoleErrorSpy).toHaveBeenCalledWith("[CodeIndexManager] Background indexing failed:", indexingError);
	...
	describe("embedder validation integration", () => {
		...
		it("should set generic error state when embedder validation throws", async () => {
			...
			// Act & Assert
			await expect((manager as any)._recreateServices()).rejects.toThrow("embeddings:validation.configurationError");
