import { BedrockRuntimeClient, type InvokeModelCommand } from "@aws-sdk/client-bedrock-runtime";
import type { MockedFunction } from "vitest";
import { clearAllMocks } from "../../../../test-utils/reset";
import { INITIAL_RETRY_DELAY_MS, MAX_ITEM_TOKENS } from "../../constants";
...
describe("BedrockEmbedder", () => {
	...
	describe("constructor", () => {
		...
		it("should identify itself as Andy Code in the AWS client app id", () => {
			expect(BedrockRuntimeClient).toHaveBeenCalledWith(
				expect.objectContaining({
					userAgentAppId: expect.stringMatching(/^AndyCode#/),
				}),
			);
		});
	});
