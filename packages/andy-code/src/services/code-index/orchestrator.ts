...
import type { BatchProcessingSummary, IFileWatcher, IVectorStore } from "./interfaces";
import type { DirectoryScanner } from "./processors";
import type { CodeIndexStateManager, IndexingState } from "./state-manager";
