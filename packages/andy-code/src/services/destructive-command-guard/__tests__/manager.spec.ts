...
import { access, chmod, mkdir, mkdtemp, readFile, rm, stat, writeFile } from "fs/promises";
...
describe("Destructive Command Guard manager", () => {
	...
	it("allows trusted relative redirects and rejects unsafe or exhausted redirects", () => {
		...
		expect(
			resolveTrustedRedirect("https://github.com/release", "https://release-assets.githubusercontent.com/asset", 5),
