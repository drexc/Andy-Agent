...
export class MdmService {
	...
	public static async createInstance(log?: (...args: unknown[]) => void): Promise<MdmService> {
		...
		MdmService._instance = new MdmService(log);
		await MdmService._instance.initialize();
		return MdmService._instance;
	}
	...
	public static hasInstance(): boolean {
		return MdmService._instance !== null;
	}
