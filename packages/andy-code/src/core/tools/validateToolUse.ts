...
import type { ExperimentId, GroupEntry, GroupOptions, ModeConfig, ToolName } from "@roo-code/types";
import { toolNames as validToolNames } from "@roo-code/types";
import { EXPERIMENT_IDS } from "../../shared/experiments";
import { FileRestrictionError, getGroupName, getModeBySlug, type Mode } from "../../shared/modes";
import { ALWAYS_AVAILABLE_TOOLS, TOOL_ALIASES, TOOL_GROUPS } from "../../shared/tools";
...
export function validateToolUse(
	...
	if (
		!isToolAllowedForMode(toolName, mode, customModes ?? [], toolRequirements, toolParams, experiments, includedTools)
	) {
