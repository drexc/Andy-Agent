...
import type { FileEntry, LineRange, ReadFileMode, ReadFileParams, ReadFileToolParams } from "@roo-code/types";
import { type ClineSayTool, isLegacyReadFileParams } from "@roo-code/types";
import * as fs from "fs/promises";
import { isBinaryFile } from "isbinaryfile";
import path from "path";
import { addLineNumbers, extractTextFromFile, getSupportedBinaryFormats } from "../../integrations/misc/extract-text";
