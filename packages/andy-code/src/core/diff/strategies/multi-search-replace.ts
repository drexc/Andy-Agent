import { DEFAULT_DIFF_FUZZY_THRESHOLD, type ToolProgressStatus } from "@roo-code/types";
import { distance } from "fastest-levenshtein";

import { addLineNumbers, everyLineHasLineNumbers, stripLineNumbers } from "../../../integrations/misc/extract-text";
import type { DiffResult, DiffStrategy, ToolUse } from "../../../shared/tools";
							...
							: `\n\nOriginal Content:\n${addLineNumbers(
									resultLines
										.slice(
											...
											Math.min(
												resultLines.length,
												(matchIndex >= 0 ? matchIndex : 0) + searchLines.length + this.bufferLines,
											),
										)
										.join("\n"),
