...
/**
 * Non-standard fields Andy Code attaches to Anthropic message params to
					...
					(acc, part) => {
						if (part.type === "tool_use") {
							...
							if (reasoningText) {
								...
								extractedReasoning = extractedReasoning ? extractedReasoning + reasoningText : reasoningText;
							}
