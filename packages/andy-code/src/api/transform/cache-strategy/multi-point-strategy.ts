...
import type { CachePointPlacement, CacheResult } from "./types";
...
export class MultiPointStrategy extends CacheStrategy {
	 ...
	 */
	private determineMessageCachePoints(minTokensPerPoint: number, remainingCachePoints: number): CachePointPlacement[] {
