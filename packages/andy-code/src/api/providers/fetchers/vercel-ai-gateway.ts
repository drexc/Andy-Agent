...
import { VERCEL_AI_GATEWAY_VISION_AND_TOOLS_MODELS, VERCEL_AI_GATEWAY_VISION_ONLY_MODELS } from "@roo-code/types";
...
const vercelAiGatewayModelSchema = z.object({
	id: z.string(),
	object: z.string(),
	// Andy Gateway / Bedrock catalog entries omit these; they are not used for routing.
