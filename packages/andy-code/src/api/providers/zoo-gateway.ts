...
import { t } from "../../i18n";
import { clearAndyCodeToken, getAndyCodeBaseUrl, resolveZooGatewaySessionToken } from "../../services/andy-code-auth";
...
const ZOO_GATEWAY_AUTH_ERROR = "Andy Gateway requires authentication. Please sign in to Andy Code first.";
