...
export class TerminalProcess extends BaseTerminalProcess {
	...
	public override async run(command: string) {
		...
		// PS-specific counter/sleep workarounds.  Prefer the Andy Code profile
		...
		let streamProcessingError: unknown;
	...
	private prepareCommandForShellIntegration(
		...
		//
		// Try the Andy Code profile first; if unset, fall back to the VS Code default
		// profile so users who haven't configured a Andy Code profile override still
