...
export const PROVIDERS: Array<{ value: string; label: string; proxy: boolean }> = [
	{ value: providerIdentifiers.openai, label: "🤖 Andy Agent / Proveedor Personalizado", proxy: true },
	...
	{ value: providerIdentifiers.moonshot, label: "Moonshot AI", proxy: false },
	...
	{ value: providerIdentifiers.openaiNative, label: "OpenAI Oficial", proxy: false },
