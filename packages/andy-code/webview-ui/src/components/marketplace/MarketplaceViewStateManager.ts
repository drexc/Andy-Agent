 ...
 *
 * This class manages the state for the marketplace view in the Andy Code extensions interface.
 *
 * IMPORTANT: Fixed issue where the marketplace feature was causing the Andy Code extensions interface
