<p align="center">
        ...
        <p align="center">
          <em>Hai bisogno di aiuto in fretta → <a href="https://discord.gg/VxfP4Vx3gX">Unisciti a Discord</a> • Preferisci l'asincrono? → <a href="https://www.reddit.com/r/AndyCode/">Unisciti a r/AndyCode</a></em>
        </p>
...
> Andy Code continua lo sviluppo di questo progetto dopo che il team di Roo
...
> [Reddit](https://www.reddit.com/r/AndyCode), oppure
> [apri una PR o una issue](https://github.com/Zoo-Code-Org/Zoo-Code).
>
> _-Andy Code Team_

## Migrazione da Roo Code a Andy Code

Puoi trovare una guida rapida per passare da Roo Code a Andy Code nella [guida alla migrazione Roo→Zoo](https://docs.ia.v2nethost.cl:3000/roo-to-zoo-migration). Vogliamo aiutare gli utenti il più possibile durante la transizione, e per questo abbiamo il nostro [Reddit](https://www.reddit.com/r/AndyCode) e il nostro [Discord](https://discord.gg/VxfP4Vx3gX). Se hai problemi o domande, passa pure e chiedi.

## Cosa ha aggiunto Andy Code rispetto a Roo Code

Andy Code parte dalle fondamenta create da Roo Code e continua ad ampliarle con:
...
- **Più modi per connettersi** — provider nuovi e ampliati, tra cui Andy Gateway, Moonshot, Kimi Code, Kenari, Friendli, OpenCode Go e molti altri.
...
🤖 Prova GLM-5.3-Flash e Gemini 3.7 Flash con il 50% di sconto per 2 settimane e MiniMax M3 completamente GRATIS per gli utenti con un saldo sul nuovo Andy Gateway. https://ia.v2nethost.cl:3000/models
...
## Cosa può fare Andy Code per TE?
...
Andy Code si adatta al tuo modo di lavorare, non il contrario:
...
Scopri di più: [Usare le Modalità](https://docs.ia.v2nethost.cl:3000/basic-usage/using-modes) • [Modalità personalizzate](https://docs.ia.v2nethost.cl:3000/advanced-usage/custom-modes)

## Risorse

- **[Documentazione](https://docs.ia.v2nethost.cl:3000):** La guida ufficiale per installare, configurare e padroneggiare Andy Code.
- **[Server Discord](https://discord.gg/VxfP4Vx3gX):** Unisciti alla community per aiuto e discussioni in tempo reale.
- **[Comunità Reddit](https://www.reddit.com/r/AndyCode):** Condividi le tue esperienze e guarda cosa stanno costruendo gli altri.
...
Ci sono diversi modi per eseguire l'estensione Andy Code:

### Modalità di sviluppo (F5)

Per lo sviluppo attivo, usa il debug integrato di VSCode:

Premi `F5` (o vai su **Esegui** → **Avvia debug**) in VSCode. Si aprirà una nuova finestra di VSCode con l'estensione Andy Code in esecuzione.
...
1.  Per prima cosa, compila il pacchetto VSIX:
    ...
    pnpm vsix
    ```
2.  Un file `.vsix` verrà generato nella directory `bin/` (ad es. `bin/andy-code-<version>.vsix`).
