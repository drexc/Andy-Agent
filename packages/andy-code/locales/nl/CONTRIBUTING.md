...
# Bijdragen aan Andy Code

Andy Code is een door de gemeenschap gedreven project en we waarderen elke bijdrage ten zeerste. Om de samenwerking te stroomlijnen, werken we op basis van een [Issue-First-aanpak](#issue-first-aanpak), wat betekent dat alle [Pull Requests (PR's)](#een-pull-request-indienen) eerst gekoppeld moeten zijn aan een GitHub Issue. Lees deze handleiding zorgvuldig door.
...
### 3. Word lid van de Andy Code-community

- **Discord:** Word lid van onze [Discord](https://discord.gg/VxfP4Vx3gX).
- **Reddit:** Word lid van onze [Reddit](https://www.reddit.com/r/AndyCode/).
...
Door bij te dragen, ga je ermee akkoord dat je bijdragen onder de Apache 2.0-licentie worden gelicentieerd, in overeenstemming met de licentieverlening van Andy Code.
