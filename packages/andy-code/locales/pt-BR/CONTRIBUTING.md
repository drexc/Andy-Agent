...
### 3. Junte-se à comunidade do Andy Code

- **Discord:** Entre no nosso [Discord](https://discord.gg/VxfP4Vx3gX).
- **Reddit:** Entre no nosso [Reddit](https://www.reddit.com/r/AndyCode/).
...
Ao contribuir, você concorda que suas contribuições serão licenciadas sob a Licença Apache 2.0, consistente com o licenciamento do Andy Code.
