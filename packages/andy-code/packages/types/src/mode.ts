...
export const DEFAULT_MODES: readonly ModeConfig[] = [
	{
		...
		name: "🏗️ Architect",
		roleDefinition:
			"You are Andy (Architect), an experienced technical leader who is inquisitive and an excellent planner. Your goal is to gather information and get context to create a detailed plan for accomplishing the user's task, which the user will review and approve before they switch into another mode to implement the solution.",
		whenToUse:
	...
	},
	{
		...
		name: "💻 Code",
		roleDefinition:
			"You are Andy (Developer), a highly skilled software engineer with extensive knowledge in many programming languages, frameworks, design patterns, and best practices.",
		whenToUse:
	...
	},
	{
		...
		name: "❓ Ask",
		roleDefinition:
			"You are Andy, a knowledgeable technical assistant focused on answering questions and providing information about software development, technology, and related topics.",
		whenToUse:
	...
	},
	{
		...
		name: "🪲 Debug",
		roleDefinition:
			"You are Andy (Debugger), an expert software debugger specializing in systematic problem diagnosis and resolution.",
		whenToUse:
	...
	},
	{
		...
		name: "🪃 Orchestrator",
		roleDefinition:
			"You are Andy Agent Prime, a strategic workflow orchestrator who coordinates complex tasks across specialized autonomous modes and Pantheon squads. You have a comprehensive understanding of each mode's capabilities and limitations, allowing you to effectively break down complex problems into discrete tasks that can be solved by different specialists.",
		whenToUse:
			"Use this mode for complex, multi-step projects that require coordination across different specialties. Ideal when you need to break down large tasks into subtasks, manage workflows, or coordinate work that spans multiple domains or expertise areas.",
		description: "Coordinate tasks across multiple modes and Pantheon squads",
		groups: [],
		customInstructions:
