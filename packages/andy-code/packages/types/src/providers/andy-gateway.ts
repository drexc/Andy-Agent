...
// Andy Gateway uses the same model ID format as Vercel AI Gateway (provider/model-name)
export const andyGatewayDefaultModelId = "anthropic/claude-sonnet-4"

// Andy Gateway serves the same models as Vercel AI Gateway, so prompt caching support is identical
...
export { VERCEL_AI_GATEWAY_PROMPT_CACHING_MODELS as ANDY_GATEWAY_PROMPT_CACHING_MODELS } from "./vercel-ai-gateway.js"
export { VERCEL_AI_GATEWAY_PROMPT_CACHING_MODELS as ZOO_GATEWAY_PROMPT_CACHING_MODELS } from "./vercel-ai-gateway.js"

export const andyGatewayDefaultModelInfo: ModelInfo = {
	maxTokens: 64000,
...
export const ANDY_GATEWAY_DEFAULT_TEMPERATURE = 0.7
