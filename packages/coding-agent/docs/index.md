# Andy Agent Documentation

Andy Agent is an RLM-native coding and research harness built around a persistent Python REPL kernel, recursive subagents, durable sessions, and a multi-process local runtime. It began as a hard fork of pi-mono, but Andy Agent is now the product, CLI, install source, and development repository.
...
- [Using Andy Agent](usage.md) - interactive mode, RLM subagents, slash commands, context files, and CLI reference.
...
- [Skills](skills.md) - markdown and Python-backed skills, including how to ask Andy Agent to create them.
...
- [Andy Agent packages](packages.md) - bundle and share extensions, skills, prompts, and themes.
- [Custom models](models.md) - add model entries for supported provider APIs.
- [Custom providers](custom-provider.md) - implement custom APIs and OAuth flows.

## Programmatic Usage

- [SDK](sdk.md) - embed Andy Agent in Node.js applications.
- [ACP mode](acp.md) - drive Andy Agent from any Agent Client Protocol client.
