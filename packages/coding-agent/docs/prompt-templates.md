> Andy Agent can create prompt templates. Ask it to build one for your workflow.
...
Andy Agent loads prompt templates from:

- Global: `~/.andy/agent/prompts/*.md`
- Project: `.andy/agent/prompts/*.md`
